...
intro_3 <-  "Our main tabs provide a comprehensive analytical view of stocks, featuring detailed instructions and clear explanations of key terminologies alongside informative graphs. The Stock Trends tab helps users understand general market trends and compare individual stock performance against the broader market. The Market Distribution tab illustrates the role of different sectors within the S&P 500 and analyzes their historical performance. The Understand Your Portfolio page allows users to test and evaluate investment strategies using Monte Carlo simulations. Finally the Stock Clustering tab offers insights into individual stocks through K-means clustering, identifying patterns among them."
